export const en = {
  ...
  export: {
    ...
    branding: 'Branding',
    showLogo: 'Show TrailReplay logo',
    background: 'Background',
    backgroundMap: 'Map',
    backgroundSolid: 'Solid Color',
    backgroundGreen: 'Green Screen',
    backgroundBlack: 'Black',
    backgroundWhite: 'White',
    backgroundNote: 'Solid background is useful for chroma keying or clean compositing in video editors. Elevation profile remains visible.',
    recording: 'Recording',
