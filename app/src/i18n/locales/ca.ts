export const ca = {
  ...
  export: {
    ...
    branding: 'Marca',
    showLogo: 'Mostrar logo de TrailReplay',
    background: 'Fons',
    backgroundMap: 'Mapa',
    backgroundSolid: 'Color Sòlid',
    backgroundGreen: 'Pantalla Verda',
    backgroundBlack: 'Negre',
    backgroundWhite: 'Blanc',
    backgroundNote: 'El fons sòlid és útil per a chroma keying o compositing net en editors de vídeo. El perfil d\'elevació roman visible.',
    recording: 'Gravant',
