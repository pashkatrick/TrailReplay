export const es = {
  ...
  export: {
    ...
    backgroundGreen: 'Pantalla Verde',
    backgroundBlack: 'Negro',
    backgroundWhite: 'Blanco',
    backgroundNote: 'El fondo sólido es útil para chroma keying o compositing limpio en editores de video. El perfil de elevación permanece visible.',
    recording: 'Grabando',
